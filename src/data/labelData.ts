...
export const BUSINESS_CONTEXTS: LabelContext[] = [
  ...
  },
  {
    ...
    entity: 'Invoice',
    fields: [
      { name: 'Invoice Number', type: 'string', path: 'Invoice.Number' },
      { name: 'Item Block', type: 'table', path: 'Invoice.Item Block' },
      { name: 'Company Code', type: 'string', path: 'Invoice.Company Code' },
      { name: 'Invoice Date', type: 'date', path: 'Invoice.Date' },
      { name: 'Account Number', type: 'string', path: 'Invoice.AccountNumber' },
      { name: 'Payment Terms', type: 'string', path: 'Invoice.PaymentTerms' },
      { name: 'Due Date', type: 'date', path: 'Invoice.DueDate' },
      { name: 'Reference Number', type: 'string', path: 'Invoice.ReferenceNumber' },
      { name: 'Sender Address', type: 'string', path: 'Invoice.SenderAddress' },
      { name: 'Company Name', type: 'string', path: 'Invoice.CompanyName' },
      { name: 'Recipient Address', type: 'string', path: 'Invoice.RecipientAddress' },
      { name: 'Description', type: 'string', path: 'Invoice.Description' },
      { name: 'Quantity', type: 'number', path: 'Invoice.Quantity' },
      { name: 'Unit Price', type: 'number', path: 'Invoice.UnitPrice' },
      { name: 'Discount', type: 'number', path: 'Invoice.Discount' },
      { name: 'Total Including GST', type: 'number', path: 'Invoice.TotalIncludingGST' },
      { name: 'Payment Details Block', type: 'string', path: 'Invoice.PaymentDetailsBlock' },
    ],
  },
  {
    id: 'handling-unit',
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'Company Code', type: 'string', path: 'Cheque.CompanyCode' },
