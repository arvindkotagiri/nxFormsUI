...
export const BUSINESS_CONTEXTS: LabelContext[] = [
  ...
  },
  {
    ...
    entity: 'Cheque',
    fields: [
      { name: 'Invoice Number', type: 'string', path: 'Cheque.InvoiceNumber' },
      { name: 'Invoice Date', type: 'date', path: 'Cheque.InvoiceDate' },
      { name: 'Voucher ID', type: 'string', path: 'Cheque.VoucherID' },
      { name: 'Gross Amount', type: 'number', path: 'Cheque.GrossAmount' },
      { name: 'Discount Taken', type: 'number', path: 'Cheque.DiscountTaken' },
      { name: 'Paid Amount', type: 'number', path: 'Cheque.PaidAmount' },
    ],
  },
  {
    id: 'payment-advice',
