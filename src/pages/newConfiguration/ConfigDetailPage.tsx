...
export function ConfigDetailPage({ isConfigurator = true }: Props) {
  ...
  //               <Title level="H3">{headerTitle}</Title>
  //               {/* <Text>
  //                 {isEditMode
  //                   ? "Update a label determination rule"
  //                   : "Create a new label determination rule"}
  //               </Text> */}
  //             </div>
  //           </div>
  //         }
  ...
  //     {/* Content grid: form + right sidebar */}
  //     <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
  //       {/* LEFT: Main form (2 columns on large) */}
  ...
  //               subtitleText="Basic label configuration details"
  //             />
  //           }
  //         >
  ...
  //             <Form>
  //               {/* Label Name */}
  //               <FormItem labelContent={<Label required>Label Name</Label>}>
  //                 <Select
  //                   value={formData.label_name || "none"}
  //                   disabled={isReadOnly}
  //                   onChange={(e: any) =>
  //                     handleLabelChange(e.detail.selectedOption?.value || "")
  //                   }
  //                 >
  ...
  //               {/* Label ID */}
  //               <FormItem labelContent={<Label>Label ID</Label>}>
  //                 <Input value={formData.label_id} readonly />
  //               </FormItem>

  //               {/* Priority */}
  //               <FormItem labelContent={<Label required>Priority</Label>}>
  ...
  //                       setField("priority", Number.isFinite(v) ? v : 1);
  //                     }}
  //                   />
  //                   <Text className="text-xs">Lower = Higher precedence</Text>
  //                 </div>
  //               </FormItem>

  //               {/* Number of labels */}
  //               <FormItem labelContent={<Label>Number of Labels</Label>}>
  //                 <Input
  //                   type="Number"
  //                   value={String(formData.number_of_labels)}
  //                   disabled={isReadOnly}
  //                   onInput={(e: any) => {
  //                     const v = parseInt(e.target.value, 10);
  //                     setField("number_of_labels", Number.isFinite(v) ? v : 1);
  //                   }}
  //                 />
  //               </FormItem>
  ...
  //                     disabled={isReadOnly}
  //                     onChange={(e: any) => setField("active", e.target.checked)}
  //                   />
  //                   <Text>{formData.active ? "Active" : "Inactive"}</Text>
  //                 </div>
  //               </FormItem>
  //             </Form>
  //           </div>
  ...
  //           header={
  //             <CardHeader
  //               titleText="Organizational Data"
  //               subtitleText="Leave fields blank to create fallback rules"
  //             />
  //           }
  //         >
  //           <div className="p-4 sm:p-5">
  //             <Form>
  //               <FormItem labelContent={<Label>Company Code</Label>}>
  //                 <Select
  //                   value={formData.company_code || "none"}
  //                   disabled={isReadOnly}
  //                   onChange={(e: any) =>
  //                     setField("company_code", e.detail.selectedOption?.value === "none" ? "" : e.detail.selectedOption?.value)
  //                   }
  //                 >
  //                   <Option value="none">Any (fallback)</Option>
  //                   {referenceData.companyCodes.map((x) => (
  ...
  //               <FormItem labelContent={<Label>Sales Organization</Label>}>
  //                 <Select
  //                   value={formData.sales_organization || "none"}
  //                   disabled={isReadOnly}
  //                   onChange={(e: any) =>
  //                     setField("sales_organization", e.detail.selectedOption?.value === "none" ? "" : e.detail.selectedOption?.value)
  //                   }
  //                 >
  //                   <Option value="none">Any (fallback)</Option>
  //                   {referenceData.salesOrgs.map((x) => (
  //                     <Option key={x.id} value={x.id}>
  //                       {x.name}
  //                     </Option>
  //                   ))}
  ...
  //               <FormItem labelContent={<Label>Plant</Label>}>
  //                 <Select
  //                   value={formData.plant || "none"}
  //                   disabled={isReadOnly}
  //                   onChange={(e: any) =>
  //                     setField("plant", e.detail.selectedOption?.value === "none" ? "" : e.detail.selectedOption?.value)
  //                   }
  //                 >
  //                   <Option value="none">Any (fallback)</Option>
  //                   {referenceData.plants.map((x) => (
  //                     <Option key={x.id} value={x.id}>
  //                       {x.name}
  //                     </Option>
  //                   ))}
  ...
  //               <FormItem labelContent={<Label>Warehouse</Label>}>
  //                 <Select
  //                   value={formData.warehouse || "none"}
  //                   disabled={isReadOnly}
  //                   onChange={(e: any) =>
  //                     setField("warehouse", e.detail.selectedOption?.value === "none" ? "" : e.detail.selectedOption?.value)
  //                   }
  //                 >
  //                   <Option value="none">Any (fallback)</Option>
  //                   {referenceData.warehouses.map((x) => (
  //                     <Option key={x.id} value={x.id}>
  //                       {x.name}
  //                     </Option>
  //                   ))}
  ...
  //               <FormItem labelContent={<Label>Shipping Point</Label>}>
  //                 <Select
  //                   value={formData.shipping_point || "none"}
  //                   disabled={isReadOnly}
  //                   onChange={(e: any) =>
  //                     setField("shipping_point", e.detail.selectedOption?.value === "none" ? "" : e.detail.selectedOption?.value)
  //                   }
  //                 >
  //                   <Option value="none">Any (fallback)</Option>
  //                   {referenceData.shippingPoints.map((x) => (
  //                     <Option key={x.id} value={x.id}>
  //                       {x.name}
  //                     </Option>
  //                   ))}
  //                 </Select>
  //               </FormItem>
  //               <FormItem labelContent={<Label>Printer</Label>}>
  //                 <Select
  //                   value={formData.printer || "none"}
  //                   disabled={isReadOnly}
  //                   onChange={(e: any) =>
  //                     setField("printer", e.detail.selectedOption?.value === "none" ? "" : e.detail.selectedOption?.value)
  //                   }
  //                 >
  //                   <Option value="none">Any (fallback)</Option>
  //                   {referenceData.printers.map((x) => (
  //                     <Option key={x.id} value={x.id}>
  //                       {x.name}
  //                     </Option>
  //                   ))}
  ...
  //         {/* Business Context */}
  //         <Card
  //           className="shadow-sm mb-15"
  //           header={
  //             <CardHeader
  //               titleText="Business Context"
  //               subtitleText="Business criteria (leave blank for fallback)"
  //             />
  //           }
  //         >
  //           <div className="p-4 sm:p-5">
  ...
  //                   disabled={isReadOnly}
  //                   onChange={(e: any) =>
  //                     setField("customer", e.detail.selectedOption?.value === "none" ? "" : e.detail.selectedOption?.value)
  //                   }
  //                 >
  //                   <Option value="none">Any (fallback)</Option>
  //                   {referenceData.customers.map((x) => (
  //                     <Option key={x.id} value={x.id}>
  //                       {x.name}
  //                     </Option>
  //                   ))}
  ...
  //               <FormItem labelContent={<Label>Process Type</Label>}>
  //                 <Select
  //                   value={formData.process_type || "none"}
  //                   disabled={isReadOnly}
  //                   onChange={(e: any) =>
  //                     setField("process_type", e.detail.selectedOption?.value === "none" ? "" : e.detail.selectedOption?.value)
  //                   }
  //                 >
  //                   <Option value="none">Any (fallback)</Option>
  //                   {referenceData.processTypes.map((x) => (
  //                     <Option key={x.id} value={x.id}>
  //                       {x.name}
  //                     </Option>
  //                   ))}
  ...
  //         <Card
  //           className="shadow-sm"
  //           header={<CardHeader titleText="Validity Period" subtitleText="Optional date restrictions" />}
  //         >
  ...
  //                 disabled={isReadOnly}
  //                 onChange={(e: any) => setField("valid_from", normalizeDate(e.target.value))}
  //               />
  //             </div>
  ...
  //                 disabled={isReadOnly}
  //                 onChange={(e: any) => setField("valid_to", normalizeDate(e.target.value))}
  //               />
  //             </div>
  //           </div>
  //         </Card>
  ...
  //         <Card
  //           className="shadow-sm"
  //           header={<CardHeader titleText="How it works" subtitleText="Priority, fallback, specificity" />}
  //         >
  //           <div className="p-4 sm:p-5 space-y-3">
  //             <div className="flex items-start gap-2">
  //               <span className="mt-0.5">
  //                 {/* <ui5-icon name="hint"></ui5-icon> */}
  //               </span>
  //               <div>
  //                 <Text>
  //                   <b>Priority:</b> Lower numbers have higher precedence.
  //                 </Text>
  //               </div>
  //             </div>
  ...
  //             <div className="flex items-start gap-2">
  //               <span className="mt-0.5">
  //                 {/* <ui5-icon name="information"></ui5-icon> */}
  //               </span>
  //               <div className="space-y-1">
  //                 <Text>
  //                   <b>Fallback:</b> Leave fields as “Any (fallback)” to match when no specific rule applies.
  //                 </Text>
  //                 <Text>
  //                   <b>Specificity:</b> More filled criteria usually makes the rule more specific.
  //                 </Text>
  //               </div>
  //             </div>
  //           </div>
  ...
  //         <div className="lg:hidden rounded-2xl border border-black/10 bg-white shadow-sm overflow-hidden">
  //           <Bar
  //             endContent={
  //               <div className="flex gap-2 py-1">
  //                 <Button design="Transparent" onClick={() => navigate("/outputs")} disabled={saving}>
  //                   Cancel
  //                 </Button>
  //                 <Button design="Emphasized" icon="save" onClick={handleSave} disabled={saving || isReadOnly}>
  //                   {saving ? "Saving..." : "Save"}
  //                 </Button>
  //               </div>
  //             }
